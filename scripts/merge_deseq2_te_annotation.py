...
def main(args):
    ...
    merged = merged.rename(columns={'Chr': 'Chromosome', 'Start': 'Start', 'End': 'End', 'Strand': 'Strand'})
...
if __name__ == '__main__':
    p = argparse.ArgumentParser(
        description="Merge DESeq2 results with peak coords and TE annotation"
    )
    p.add_argument('--deseq2', required=True,
                   help="CSV of DESeq2 results (has 'peak' column)")
